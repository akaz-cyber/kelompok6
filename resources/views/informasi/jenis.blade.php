          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="blog-single.html">jenis-jenis photografi</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single.html">UNKNOWN</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single.html"><time datetime="2020-01-01">jan 4, 2022</time></a></li>
                </ul>
              </div>

              <div class="entry-content">
                <p>
                Bagi kamu yang ingin belajar mendalami bidang fotografi, untuk menjadi fotografer profesional tentunya kamu perlu tahu ilmu dasar
                fotografi seperti jenis-jenis fotografi apa yang ingin benar-benar kamu tekuni. Jenis-jenis fotografi ini bisa membantu kamu
                mengenal keahlian kamu berada di gaya mana. Berikut jenis-jenis fotografi
                 </p>
                <h3>
                1. Food Photography
                </h3>
